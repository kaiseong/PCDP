...
from pcdp.model.diffusion.conv1d_components import (
    Downsample1d, Upsample1d, Conv1dBlock)
from pcdp.model.diffusion.positional_embedding import SinusoidalPosEmb
    ...
    def __init__(self,
        ...
        if condition_type == 'film': # FiLM modulation https://arxiv.org/abs/1709.07871
            ...
            self.cond_encoder = nn.Sequential(
                nn.Mish(),
                nn.Linear(cond_dim, cond_channels), # 384, 1024
