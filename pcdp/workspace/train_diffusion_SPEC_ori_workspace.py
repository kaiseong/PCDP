...
from pcdp.policy.diffusion_SPEC_ori import SPECPolicyOri
from pcdp.dataset.base_dataset import BasePointCloudDataset
from pcdp.dataset.SPEC_ori_stack_dataset import collate_fn
...
class TrainSPECOriWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg:OmegaConf, output_dir = None):
        ...
        # configure model
        self.model: SPECPolicyOri = hydra.utils.instantiate(cfg.policy)
        
        self.ema_model: SPECPolicyOri = None
    ...
    def run(self):
        ...
        for epoch in range(start_epoch, cfg.training.num_epochs):
            ...
            for data in pbar:
                ...
                loss = self.model(
                    cloud_data, action_data, batch_size=action_data.shape[0])
