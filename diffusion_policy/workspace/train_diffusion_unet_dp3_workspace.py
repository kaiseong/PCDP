...
from diffusion_policy.policy.diffusion_unet_dp3_policy import DP3Policy
...
class TrainDP3Workspace(BaseWorkspace):
    ...
    def __init__(self, cfg:OmegaConf, output_dir = None):
        ...
        # configure model
        self.model: DP3Policy = hydra.utils.instantiate(cfg.policy)
        
        self.ema_model: DP3Policy = None
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}",
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        # compute loss
                        t1_1 = mono_time.now_s()
                        raw_loss, loss_dict = self.model.compute_loss(batch)
                        loss = raw_loss / cfg.training.gradient_accumulate_every
                        loss.backward()

                        t1_2= mono_time.now_s()
                        ...
                        t1_3 = mono_time.now_s()
                        # update ema
                        if cfg.training.use_ema:
                            ema.step(self.model)
                        t1_4 = mono_time.now_s()
